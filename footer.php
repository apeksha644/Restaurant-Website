	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Solapur Pin - 413307</p>
					<p class="lead"><a href="#">+91 985 8745 799</a></p>
					<p><a href="#"> royal@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2020 <a href="#">Royak Restaurant</a> Developed By :  Nagesh Patil
					<a href=""></a><br>
